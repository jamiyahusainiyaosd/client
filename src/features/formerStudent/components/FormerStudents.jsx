          ...
          {items.map((x) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {x.current && (
                  <span className="mt-1 inline-flex items-center rounded-full bg-emerald-50 dark:bg-emerald-900/30 px-2 py-0.5 text-[10px] font-semibold text-emerald-700 dark:text-emerald-400 truncate max-w-full">
                    {x.current}
                  </span>
                )}
