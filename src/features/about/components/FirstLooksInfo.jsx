  ...
  return (
    <section className="rounded-2xl border border-slate-200/80  bg-white/70  backdrop-blur-sm overflow-hidden">
      <div className="px-6 pt-6 pb-4 border-b border-slate-100  flex items-center gap-3">
        ...
        <div>
          <h3 className="text-base font-bold text-slate-900 ">এক নজরে জামিয়া হুসাইনিয়া</h3>
          <p className="text-xs text-slate-400 ">প্রতিষ্ঠানের মূল তথ্য, কাঠামো ও আর্থিক ব্যবস্থাপনা</p>
        </div>
      </div>
      <div className="p-5">
