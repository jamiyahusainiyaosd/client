  ...
  return (
    <article className="h-full rounded-2xl border border-slate-200/80 dark:border-slate-700/60 bg-white/70 dark:bg-slate-800/40 backdrop-blur-sm overflow-hidden">
      <div className="px-5 pt-5 pb-4 border-b border-slate-100 dark:border-slate-700/60 flex items-center gap-3">
        ...
        <div>
          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">বৈশিষ্ট্যসমূহ</h3>
          <p className="text-xs text-slate-400 dark:text-slate-500">অন্যান্য প্রতিষ্ঠানের তুলনায় স্বাতন্ত্র্যসূচক দিক</p>
        </div>
      </div>
      <ul className="p-5 space-y-3">
        {aboutData.features.map((feature, index) => (
          <li key={index} className="flex items-start gap-3 text-sm">
            ...
            <span className="text-slate-600 dark:text-slate-300 leading-relaxed text-justify">{feature}</span>
          </li>
        ))}
      </ul>
    </article>
