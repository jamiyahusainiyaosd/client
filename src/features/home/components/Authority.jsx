...
const Authority = ({ name, title }) => {
  return (
    <div className="p-3 rounded-xl bg-gradient-to-br from-gray-700 to-gray-800 border border-gray-600 shadow-lg hover:shadow-xl transition-all duration-300 space-y-3 w-full">
      <img
        src={avaterImage}
        alt={`${name}'s avatar`}
