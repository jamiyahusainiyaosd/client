    ...
    <>
      <form onSubmit={handleSubmit} className="p-6 shadow-2xl rounded-lg">
        ...
        <div className="mb-4">
          ...
          <input type="text" name="name" placeholder="আপনার নাম" value={payload.name} onChange={handleChange} className="w-full p-2 border rounded-md focus:outline-none focus:ring-2" />
        ...
        <div className="mb-4">
          ...
          <input type="email" name="email" placeholder="আপনার ই-মেইল" value={payload.email} onChange={handleChange} className="w-full p-2 border rounded-md focus:outline-none focus:ring-2" />
        ...
        <div className="mb-4">
          ...
          <input type="text" name="phone" placeholder="আপনার ফোন নাম্বার ১১ ডিজিটের" value={payload.phone} onChange={handleChange} className="w-full p-2 border rounded-md focus:outline-none focus:ring-2" />
        ...
        <div className="mb-4">
          ...
          <textarea name="message" value={payload.message} onChange={handleChange} rows="4" placeholder="মাদ্রাসা কতৃপক্ষের সাথে আপনি কোন বিষয়ে কথা বলতে চান তা বিস্তারিত লিখুন। আপনার ইমেইল পাঠানোর পর যদি কোনো উত্তর না পান তাহলে ফোন করে বা সরাসরি মাদ্রাসায় এসে কথা বলুন।" className="w-full p-2 border rounded-md focus:outline-none focus:ring-2" />
