            ...
            <ul className="p-6 space-y-3">
              {qualifications.map((item, index) => (
                <li key={index} className="flex items-start gap-3 text-sm">
                  ...
                  />
                  <span className="text-slate-600 leading-relaxed text-bengali">
                    {item}
                  </span>
                </li>
              ))}
                  ...
                  <thead>
                    <tr className="border-b border-slate-200 bg-slate-50">
                      {tableHeaders.map((header, idx) => (
                        <th
                          key={idx}
                          className="px-4 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-slate-700 font-mono whitespace-nowrap"
                        >
                          {header}
                        </th>
                      ))}
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {refinedData.length > 0 ? (
                      ...
                      <tr>
                        <td
                          colSpan={13}
                          className="text-center py-10 text-sm text-slate-500 font-sans"
                        >
